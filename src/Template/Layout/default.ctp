                ...
                <div class="header-menu">
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                            ...
                            <div class="dropdown-menu" aria-labelledby="message">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><?= $this->Html->image("avatar/1.jpg");?></span>
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><?= $this->Html->image("avatar/2.jpg");?></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><?= $this->Html->image("avatar/3.jpg");?></span>
                                    <div class="message media-body">
                                ...
                                <a class="dropdown-item media" href="#">
                                    <span class="photo media-left"><?= $this->Html->image("avatar/4.jpg");?></span>
                                    <div class="message media-body">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <?= $this->Html->image('admin.jpg', ['class' => 'user-avatar rounded-circle']);?>
                        </a>
